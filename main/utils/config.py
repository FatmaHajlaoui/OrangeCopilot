...
class Config:
    # database config
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:Mysql%402026@localhost:3306/projet_pfe"
    ...
    MAIL_USE_TLS = False
    MAIL_USE_SSL = True
    MAIL_USERNAME = 'aouissibilel182@gmail.com'
    MAIL_PASSWORD = 'kuqd lqer oqsd llqb'
