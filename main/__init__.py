...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        from .FH.controllers.fh_ai import fh_ai_routes
        ...
        from .Radio.controllers.mohsen import mohsen_routes
        ...
        app.register_blueprint(fh_ai_routes.fh_ai_bp, url_prefix='/fh')
        ...
        app.register_blueprint(mohsen_routes.radio_mohsen_bp, url_prefix='/radio')
