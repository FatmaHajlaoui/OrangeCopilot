...
class Mohsen(db.Model):


    id = db.Column(db.Integer, primary_key=True)
    Cell_Name = db.Column(db.String(100), nullable=False)
    mean_rtwp = db.Column(db.Float, nullable=False)
    max_rtwp = db.Column(db.Float, nullable=False)
    min_rtwp = db.Column(db.Float, nullable=False)
    occ_rtwp_gt_98  = db.Column(db.Float, nullable=False)
    vs_mean_rtwp_ant0 = db.Column(db.Float, nullable=False)
    vs_mean_rtwp_ant1 = db.Column(db.Float, nullable=False)
    occ_diff_sect_gt_5 = db.Column(db.Float, nullable=False)
    creation_date = db.Column(db.DateTime, nullable=False, index=True, unique=False)
